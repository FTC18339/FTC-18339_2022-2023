...
public class Algorithms003 {
    ...
    public double getLinearActuatorForce(double y) {
        if ((y > 0) || (y < 0)) {
            return y * actuatorControlMultiplier;
        } else {
            return 0;
        }
    }
    ...
    public double getGripperArmForce(double y) {
        if ((y > 0) || (y < 0)) {
            return y * armControlMultiplier;
        } else {
            return 0;
        }
    }

    public double getRotatorMotorForce(double y) {
        if ((y > 0) || (y < 0)) {
            return y * rotatorControlMultiplier;
        } else {
            return 0;
        }
    }
